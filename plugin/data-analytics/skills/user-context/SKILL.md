...
- Read `~/.zcode/cli/plugins/data/data-analytics@zcode-community/onboarding-state.json` only when onboarding state, semantic-layer refresh setup, hero prompt progress, or progressive nudges are relevant.
...
```text
~/.zcode/cli/plugins/data/data-analytics@zcode-community/user-context.md
```

The configured onboarding-state file is JSON:

```text
~/.zcode/cli/plugins/data/data-analytics@zcode-community/onboarding-state.json
```
